package com.github.lakeshire.discounts.view.pulltofresh;
 ...
 */
public class EnhancePtrFrameLayout extends ViewGroup {
    ...
    private static byte FLAG_PIN_HEADER = 0x01 << 4;
    ...
    public EnhancePtrFrameLayout(Context context) {
        this(context, null);
    }

    public EnhancePtrFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EnhancePtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
